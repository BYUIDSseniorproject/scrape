...
tdat <- read_parquet("temple_example/temple_details_nolatlong.parquet")
temple_address <- read_parquet("temple_example/temple_latlong.parquet") |>
        mutate(
...
write_parquet(temple_details, "temple_example/temple_details.parquet")
write_csv(temple_details, "temple_example/temple_details.csv")
